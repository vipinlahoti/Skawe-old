...
addStrings('en', {
  ...
  'posts.edit': 'Edit',
  'posts.create_success': 'Post “{title}” created.',
  ...
  'departments.subscribe': 'Subscribe to this category\'s posts',
  'departments.unsubscribe': 'Unsubscribe to this category\'s posts',
  ...
  'departments.delete_confirm': 'Delete category “{title}”?',
  'departments.delete_success': 'Department “{name}” deleted.',
  'departments.invalid': 'Invalid category',
  ...
  'admin.replies': 'Replies (admin)',
  'admin.features': 'Features (admin)',
  'admin.pages': 'Pages (admin)',
  'admin.distributions': 'Distributions (admin)',
  'admin.regions': 'Regions (admin)',
  'admin.server-plans': 'Server Plans (admin)',
  ...
  // Instance
  //===================================//
  'instance.password_check_offline': 'Instance must be powered off in order to reset root password.',
  'instance.password_change_success': 'Instance password changed successfully.',
  'instance.delete_confirm': 'Delete instance?',
  'instance.deleted': 'Deleted successfully',
  'instance.edited': '“{name}” successfully',
  'instance.rebuild_success': 'Instance Rebuild successfull',
  'instance.rebuild_starting': 'Instance Rebuild starting',
  'instance.resize_starting': 'Instance Resize starting',
  'instance.resize_success': 'Instance Resize successfull',
  'instance.resize_upgrade_higher': 'Instance has allocated more disk space than the new service plan allows, Please select higher then current plan.',
  'instance.backup_enabled': 'Backup Enabled',
  'instance.backup_restore_starting': 'Backup Restore started.',
  'instance.backup_restore_success': 'Backup Restore successfull',
  'instance.backup_cancelled': 'Backup Cancelled',
  'instance.rate_limit_error': 'Please wait {value} seconds before creating again.',
  'instance.dateNotDefined': 'Date not defined',
  'instance.max_per_day': 'Sorry you cannot create more than {value} instances per day.',
  'instance.add_private_ipv4_success': 'Private IPv4 has added successfull',
  'instance.reactivate_backup': 'Please wait 24 hours before reactivating backups for this Instance',

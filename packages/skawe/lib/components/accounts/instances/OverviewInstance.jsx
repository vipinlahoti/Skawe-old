...
const OverviewInstance = ({instance, instanceSingle}) => {
  return (
    <React.Fragment>
      <div className="section-distributions bg-light mb-1">
        <ul className="list small-list count-list">
          <li><span className="list-label">Location:</span> {instanceSingle.region}</li>
...
registerComponent({ name: 'OverviewInstance', component: OverviewInstance });

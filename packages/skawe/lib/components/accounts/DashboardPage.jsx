        ...
        <Row>
          <Col md={10} sm={12} xs={12}>
            <div className="mb-3">
              ...
              <Row>
                <Col>
                  <div className="instances__list instances__list-dashboard">
            ...
            <div className="mb-3">
              <Row>
                ...
                <Col>
                  <div className="d-flex end-xs">
                    <Components.Button variant="primary-link" size="small" className="pr-0" path="/accounts/list-dns-manager" isLink={true}>
                      <Components.Icon name="add_circle_outline" />
                      Add a Domain
                    </Components.Button>
                  </div>

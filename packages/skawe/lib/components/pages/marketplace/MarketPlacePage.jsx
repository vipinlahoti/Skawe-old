...
const MarketPlacePage = () => {
  return (
    <React.Fragment>
      <Components.HeadTags title="Marketplace Catalog" description="Marketplace Catalog Page" />
                    ...
                    <Col md={3} key={index}>
                      <ListGroup className="market-list mb-1">
                        <ListGroup.Item>
                          ...
                          <Components.Button isLink={true} path={os.path} size="small" className="flat-link">
                            Learn More
                          </Components.Button>
                        </ListGroup.Item>
                      </ListGroup>
                  ...
                  <Col md={3} key={index}>
                    <ListGroup className="market-list mb-1">
                      <ListGroup.Item>
                        ...
                        <Components.Button isLink={true} path={app.path} size="small" className="flat-link">
                          Learn More
                        </Components.Button>
                      </ListGroup.Item>
                    </ListGroup>
...
registerComponent({ name: 'MarketPlacePage', component: MarketPlacePage });

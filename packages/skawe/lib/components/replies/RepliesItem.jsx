    ...
    return (
      <div className="media" id={reply._id}>
        ...
        <div className="media__body">
          <div className="media__body-heading"><strong><Components.UsersName user={reply.user} /></strong> / <span className="media-time">{moment(new Date(reply.postedAt)).fromNow()}</span></div>

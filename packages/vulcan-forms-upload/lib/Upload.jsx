...
registerSetting('cloudinary.cloudName', 'skawe', 'Cloudinary cloud name (for image uploads)');
    ...
    return (
      <div className={`upload-image ${this.props.loading ? 'upload-image-loading' : ''} ${this.props.error ? 'upload-image-error' : ''}`}>
        <div className="upload-image-contents">
          <img style={{ height: 70 }} src={getImageUrl(this.props.image)} />
          {this.props.loading && (
        ...
        <Components.Button variant="primary-link" size="small" className="pl-0" onClick={this.clearImage}>
...
class Upload extends PureComponent {
  ...
  */
  ...
  render() {
    ...
    return (
      <div className={`form-group ${this.isDisabled() ? 'upload-disabled' : ''}`}>
